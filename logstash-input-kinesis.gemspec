...
Gem::Specification.new do |spec|
  ...
  spec.requirements << "jar 'com.amazonaws:amazon-kinesis-client', '3.1.2'"
  spec.requirements << "jar 'com.amazonaws:aws-java-sdk-core', '2.33.3'"
  spec.requirements << "jar 'com.amazonaws:aws-java-sdk-sts', '2.33.3'"
